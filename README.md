<p align="center">
	...
	<a href="#breakpoints" style="color: #b873ff!important">breackpoints</a>
	<a href="#contendores-y-sistema-de-columnas-grid" style="color: #b873ff!important">grid</a>
	<a href="href="#child-cols-con-tres-3-niveles-de-espaciado-child-spacing-123-añade-tamaño-en-común-a-todos-los-hijos-de-un-child-cold-único-en-boogo"" style="color: #b873ff!important">Child-col (nuevo)</a>
	<a href="#ordene-la-posición-de-sus-elementos-en-la-web-con-nuestras-clases-order-y-aplique-reglas-para-los-diferentes-breakpoints-único-en-boogo" style="color: #b873ff!important">order (nuevo)</a>
	<a href="#row-cols-divide-en-columnas-a-hijos-de-un-row" style="color: #b873ff!important">row-cols (nuevo)</a>
	<a href="#offset" style="color: #b873ff!important">offset</a>
	<a href="#margenes-y-espaciados" style="color: #b873ff!important">márgenes y espaciados</a>
	<a href="#borders" style="color: #b873ff!important">borders</a>
